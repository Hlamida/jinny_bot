...
class GPT():
    ...
    def google_download(self, option):
    ...
    def google_load_search_indexes(self, option) -> str:
        documents = self.google_download(option)

        return self.create_embedding(documents)
...
def telegram_ask(prompt):
    ...
    marketing_chat_promt = gpt.google_download('promts')
